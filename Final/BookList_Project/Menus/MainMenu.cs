...
internal class MainMenu
{
    ...
    public async Task ManageBookRatings()
    {
        ...
        do
        {
            ...
            Console.WriteLine("1. View book rating from book in booklist");
            Console.WriteLine("2. Rate a book from booklist");
            Console.WriteLine("3. Update book rating from book in booklist");
            Console.WriteLine("0. Exit");
            var option = Console.ReadLine();
